...
<div class="ml-4 my-properties">
    <form action="{{ route('admin.form-caracteristique-property-post') }}" method="post">
        @csrf
        <div class="mb-3">
            <h4>
                {{ $isModif ? 'Modification de Caracteristique de Propriété' : 'Nouvel Enregistrement de Caracteristique de Propriété' }}
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="libelle" id="formGroupExampleInput2" placeholder="Entrer un type de propriété" value="{{ $isModif ? $caracteristiqueProperty->libelle : '' }}">

            <input type="hidden" name="id" value="{{ $isModif ? $caracteristiqueProperty->id : '' }}">
        </div>
